...
export const modals = () => {
  ...
  bindModal(".modal__register-btn", ".modal-register", ".modal__close");
  bindModal(".modal__login-btn", ".modal__login", ".modal__close");
  bindModal(".modal__recovery-btn", ".modal__recovery", ".modal__close");
